...
<div class="block-categories hidden-sm-down">
	<ul class="category-top-menu">
		<li>
			<a class="headings headings-small text-uppercase" href="{$categories.link nofilter}">
				<div class="navbar-toggler collapse-icons" data-toggle="collapse" data-target="#exCollapsingNavbar{$categories.id}" aria-expanded="true">
		...
		<li>
			<div class="collapse in" id="exCollapsingNavbar{$categories.id}">
