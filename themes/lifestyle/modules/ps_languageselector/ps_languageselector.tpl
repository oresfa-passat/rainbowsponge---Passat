...
<div id="_desktop_language_selector" class="pull-lg-right clearfix">
  <div class="language-selector-wrapper">
    <div class="language-selector dropdown js-dropdown custom-link-color">
      <span class="regular-text expand-more hidden-sm-down" data-toggle="dropdown">{$current_language.name_simple}</span>
      ...
      <ul class="dropdown-menu hidden-sm-down">
        {foreach from=$languages item=language}
          <li {if $language.id_lang == $current_language.id_lang} class="current" {/if}>
            <a href="{url entity='language' id=$language.id_lang}" class="dropdown-item regular-text custom-link-color">
