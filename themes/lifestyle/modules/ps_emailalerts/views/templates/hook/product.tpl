...
<div class="js-mailalert" data-url="{url entity='module' name='ps_emailalerts' controller='actions' params=['process' => 'add']}">
	{if isset($email) AND $email}
		<input type="email" class="form-control" placeholder="{l s='your@email.com' d='Modules.Mailalerts.Shop'}"/><br />
	{/if}
	<input type="hidden" value="{$id_product}"/>
	<input type="hidden" value="{$id_product_attribute}"/>
	<a href="#" rel="nofollow" onclick="return addNotification();" class="btn btn-small custom-button">{l s='Notify me when available' d='Modules.Mailalerts.Shop'}</a>
