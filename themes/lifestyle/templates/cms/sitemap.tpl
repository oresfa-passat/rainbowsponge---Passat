...
{block name='page_content_container'}
	<div class="container-fluid">
		<div class="sitemap">
			<div class="row">
				<div class="col-md-3">
					<h2 class="headings headings-medium text-uppercase">{$our_offers}</h2>
					{include file='cms/_partials/sitemap-nested-list.tpl' links=$links.offers}
				</div>
				<div class="col-md-3">
					<h2 class="headings headings-medium text-uppercase">{$categories}</h2>
					{include file='cms/_partials/sitemap-nested-list.tpl' links=$links.categories}
				</div>
				<div class="col-md-3">
					<h2 class="headings headings-medium text-uppercase">{$your_account}</h2>
					{include file='cms/_partials/sitemap-nested-list.tpl' links=$links.user_account}
				</div>
				<div class="col-md-3">
					<h2 class="headings headings-medium text-uppercase">{$pages}</h2>
