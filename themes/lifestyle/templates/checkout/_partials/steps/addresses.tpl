...
{block name='step_content'}
	<div class="js-address-form">
		...
		>
			...
			{if !$use_same_address}
				<h2 class="headings headings-small">{l s='Shipping Address' d='Shop.Theme.Checkout'}</h2>
			{/if}
			...
			{elseif $customer.addresses|count > 0}
				...
				<p class="add-address">
					<a class="regular-text custom-link-color" href="{$new_address_delivery_url}">
						<i class="fa fa-plus"></i> {l s='add new address' d='Shop.Theme.Actions'}
					</a>
				</p>

				{if $use_same_address && !$cart.is_virtual}
					<p>
						<a class="regular-text custom-link-color" data-link-action="different-invoice-address" href="{$use_different_address_url}">
			...
			{if !$use_same_address}
				...
				<h2 class="headings headings-small">{l s='Your Invoice Address' d='Shop.Theme.Checkout'}</h2>
				...
				{else}
					...
					<p class="add-address">
						<a class="regular-text custom-link-color" href="{$new_address_invoice_url}">
							<i class="fa fa-plus"></i> {l s='add new address' d='Shop.Theme.Actions'}
						</a>
					</p>
				{/if}
			...
			{if !$form_has_continue_button}
				<div class="clearfix">
					<button type="submit" class="btn btn-small custom-button continue pull-xs-right" name="confirm-addresses" value="1">
