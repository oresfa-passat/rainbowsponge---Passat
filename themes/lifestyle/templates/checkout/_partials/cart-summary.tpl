	...
	<div>
		...
		{block name='cart_summary_products'}
			<div class="cart-summary-products">
				...
				<p class="regular-text default-text">{$cart.summary_string}</p>

				<p class="pull-xs-right">
					<a class="regular-text custom-link-color" href="#" data-toggle="collapse" data-target="#cart-summary-product-list">
