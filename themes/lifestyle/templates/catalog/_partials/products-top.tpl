...
<div id="js-product-list-top" class="row products-selection">
	<div class="col-lg-6 col-md-4 hidden-sm-down total-products">
		{if $listing.pagination.total_items > 1}
			<p class="regular-text default-text">{l s='There are %product_count% products.' d='Shop.Theme.Catalog' sprintf=['%product_count%' => $listing.pagination.total_items]}</p>
		{else if $listing.pagination.total_items > 0}
			<p class="regular-text default-text">{l s='There is 1 product.' d='Shop.Theme.Catalog'}</p>
		{/if}
	</div>
